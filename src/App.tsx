  ...
  return (
    <>
      <Stage onAdvance={stepper.next}>
        ...
        <div className="page-num-badge">
          <span className="pn-cur">{String(stepper.globalIndex + 1).padStart(2, "0")}</span>
          <span className="pn-sep">/</span>
          <span className="pn-tot">{String(stepper.totalGlobal).padStart(2, "0")}</span>
        </div>
      </Stage>
      <ProgressBar
        chapters={CHAPTERS}
